...
class CUST : public USERS {
    ...
    public:
        ...
        void checkout() {
            ...
            cout << setw(20) << "Book ID#" << setw(30) << "Book Title" << setw(10) << "Price" << setw(10) << "Quantity" << endl;

            // Display all items in cart
            cart* temp = carthead;
            while (temp != NULL) {
                if (temp->cart_username == pass_un) {
                    cout << setw(20) << temp->cart_productid;
            ...
            if (choice == 1) {
                ...
                // Display successful message
                cout << "Quantity updated for Book ID #" << tempbookid << "!" << endl;
                checkout();
            }
            else if (choice == 3) {
                ...
                // Display successful message
                cout << "Book ID #" << tempbookid << " deleted from the cart!" << endl;
                checkout();
            }
            else if (choice == 4) {
                // Checkout Function
